...
defense_eval.py
---------------
(1) Evaluate the undefended victim under unconstrained vs constrained attacks.
(2) Train the DEFENDED model via adversarial training on CONSTRAINED examples.
(3) Produce the main results table: clean / unconstrained-attack /
    constrained-attack accuracy for undefended vs defended, plus the validity
    rate of unconstrained attacks.

Usage:
    python defense_eval.py --out_dir ../outputs --epochs 20
"""
